...
st.set_page_config(page_title="Passion8", 
                   page_icon="8️⃣", 
                   initial_sidebar_state="collapsed",
                   menu_items={'About': 'For detailed implementations, please visit https://github.com/freedytan/Passion8.'})
...
with logo:
    com.iframe("https://lottie.host/embed/57930a62-cb53-47b8-b028-a287a7715222/RskPzQ3i5e.json")

# Display the text 
st.markdown('<div class="big-text">Ecommerce Analysis and Optimization</div>', unsafe_allow_html=True)
...
words_col6 = ["AI Recommendation Bot", "Computer Vision", "Sentiment Analysis"]


# Generate HTML strings for each column
html_col4 = "<div class='col4'>" + "".join([f"<span style='color:#00008B'>- {word}</span><br>" for word in words_col4]) + "</div>"
html_col5 = "<div class='col5'>" + "".join([f"<span style='color:#00008B'>- {word}</span><br>" for word in words_col5]) + "</div>"
html_col6 = "<div class='col6'>" + "".join([f"<span style='color:#00008B'>- {word}</span><br>" for word in words_col6]) + "</div>"
