...
def main():
    ...
    st.set_page_config(page_title="Bonus", page_icon="⭐", layout="wide",initial_sidebar_state="collapsed")
    st.page_link("Hello.py", label="⬅ BACK")
    st.markdown("# Bonus")

    tab1, tab2, tab3, tab4 = st.tabs(["💬 AI Recommendation Chatbot","🖼️ Computer Vision", "🔤 Sentiment Analysis", "📧 AI Personalized Marketing"])
